...
public class AnnmitionViewPager extends ViewPager {
	...
	public AnnmitionViewPager(Context context, AttributeSet attrs) {
		...
		TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.AnnmitionViewPager);
		int effect = ta.getInt(R.styleable.AnnmitionViewPager_style, 0);
		...
		setFadeEnabled(ta.getBoolean(R.styleable.AnnmitionViewPager_fadeEnabled, false));
		setOutlineEnabled(ta.getBoolean(R.styleable.AnnmitionViewPager_outlineEnabled, false));
		setOutlineColor(ta.getColor(R.styleable.AnnmitionViewPager_outlineColor, Color.WHITE));
		switch (mEffect) {
		case Stack:
		case ZoomOut:
			setFadeEnabled(true);
