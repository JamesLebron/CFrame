...
public class ScrollingTabsView extends HorizontalScrollView implements OnPageChangeListener {
    ...
    public ScrollingTabsView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSpacingExtra = a.getDimensionPixelSize(R.styleable.ViewPagerExtensions_spacingExtra, mSpacingExtra);
    ...
    private void initTabs() {
        ...
        currentPostion = mPager.getCurrentItem();
   ...
   /* @Override
    protected Parcelable onSaveInstanceState() {
        ...
        savedState.currentPosition = currentPostion;
        Logs.w("currentPostion", savedState.currentPosition + "   onSaveInstanceState");
        return savedState;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        try {
            ...
            currentPostion = savedState.currentPosition;
            Logs.w("0000", currentPostion + "   onRestoreInstanceState");
        } catch (Exception e) {
            state = null;
            e.printStackTrace();
        }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
       ...
       // bundle.getInt("position");
        Logs.i("bundle",bundle.getInt("position")+"   /////");
    }
    ...
    private View getSeparator() {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(mSpacingExtra, LayoutParams.FILL_PARENT);
